  ...
  "
      ...
      <section className="relative w-full h-screen overflow-hidden bg-black font-['Inter']">
        ...
        <div className="absolute bottom-6 left-6 right-6 z-30 md:hidden flex flex-col gap-4">
          ...
          <button className="w-full bg-white text-black py-4 px-6 text-[13px] rounded-sm font-medium flex items-center justify-between hover:bg-[#f2f2f2] transition-all duration-300">
            Book a Consultation
            <span className="text-lg">→</span>
          </button>
        </div>
